      ...
      <main className="mx-auto max-w-4xl space-y-12">
        ...
        <div className="border-b border-border pb-8">
          ...
          <p className="mt-2 text-text-body">
            Stay on track with your upcoming field inspections, seminars, and certification
            deadlines.
          </p>
        </div>
          ...
          {scheduleItems.map((item) => (
            ...
            >
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex flex-wrap gap-x-6 gap-y-2 text-[11px] font-bold text-text-muted uppercase tracking-widest">
                    <span className="flex items-center gap-1.5">
                      <Clock className="h-3.5 w-3.5 text-brand-primary" /> {item.time}
                    </span>
                    <span className="flex items-center gap-1.5">
                      <MapPin className="h-3.5 w-3.5 text-brand-primary" /> {item.location}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-4 md:mt-0 pt-4 md:pt-0 border-t md:border-t-0 border-border md:border-l border-border md:pl-6 flex items-center justify-between md:justify-center">
                <span
                  className={`inline-flex items-center gap-1.5 px-3 py-1 rounded text-[9px] font-black uppercase tracking-widest ${
