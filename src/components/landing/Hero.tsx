        ...
        <div className="grid grid-cols-1 items-center gap-16 lg:grid-cols-12 lg:gap-10">
          ...
          <div className="space-y-8 lg:col-span-7">
            ...
            <p className="max-w-2xl text-sm leading-relaxed text-white/65 md:text-base">
              The centralized digital learning infrastructure for the
              Electricity Company of Ghana — synchronizing curriculum
              management, compliance tracking, certification verification,
              and operational workforce development through a modern
              enterprise-grade LMS ecosystem.
            </p>
