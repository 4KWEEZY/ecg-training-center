        ...
        <div className="flex flex-wrap items-end justify-between gap-6">
          <div>
            ...
            <p className="mt-4 max-w-xl text-white/70">
              Six required modules every new ECG staff member completes during the first six weeks
              of orientation. Self-paced video lessons, downloadable materials, and end-of-module
              quizzes.
            </p>
          </div>
          <Link
            ...
            >
              ...
              <div className="mt-5 flex items-center gap-5 border-t border-white/10 pt-4 text-xs text-white/60">
                <span className="flex items-center gap-1.5">
                  <PlayCircle className="h-3.5 w-3.5 text-yellow" /> {lessons} lessons
                </span>
                <span className="flex items-center gap-1.5">
                  <FileText className="h-3.5 w-3.5 text-yellow" /> Notes
                </span>
                <span className="flex items-center gap-1.5">
                  <ClipboardList className="h-3.5 w-3.5 text-yellow" /> {quizzes} quizzes
                </span>
              </div>
