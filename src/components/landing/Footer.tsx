  ...
  return (
    <footer className="bg-brand-dark text-white/80 border-t border-white/5">
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 px-6 py-16 md:grid-cols-4">
        ...
        <div>
          <div className="flex items-center gap-3">
            ...
            <div className="font-display font-semibold uppercase leading-tight text-white">
              ...
              <div className="text-[10px] uppercase tracking-widest text-white/60">LMS System v2.0</div>
            </div>
          </div>
          <p className="mt-5 max-w-xs text-xs md:text-sm text-white/60 leading-relaxed">
            The professional learning destination of the Electricity Company of Ghana. Automating industrial workflows, evaluations, and core technical certifications.
          </p>
        ...
        <div>
          <div className="mb-4 text-xs font-bold uppercase tracking-[0.25em] text-yellow">Programmes</div>
          <ul className="space-y-2.5 text-xs md:text-sm">
            <li><Link to="/courses" className="hover:text-yellow transition-colors">Course Catalog</Link></li>
            <li><Link to="/library" className="hover:text-yellow transition-colors">Resource Archive</Link></li>
            <li><Link to="/quizzes" className="hover:text-yellow transition-colors">Assessments Engine</Link></li>
            <li><Link to="/certificates" className="hover:text-yellow transition-colors">Verified Credentials</Link></li>
          </ul>
        </div>

        <div>
          <div className="mb-4 text-xs font-bold uppercase tracking-[0.25em] text-yellow">Trainee Resources</div>
          <ul className="space-y-2.5 text-xs md:text-sm">
            <li><Link to="/documents" className="hover:text-yellow transition-colors">Orientation Handbooks</Link></li>
            <li><Link to="/schedule" className="hover:text-yellow transition-colors">Workshop Calendar</Link></li>
            <li><Link to="/progress" className="hover:text-yellow transition-colors">Performance Tracking</Link></li>
            <li><Link to="/version" className="hover:text-yellow transition-colors">Release Metrics</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-xs md:text-sm mb-5">
            ...
            <li className="flex items-center gap-2">
              ...
              <a href="tel:+233302611611" className="text-white/70 hover:text-yellow transition-colors">+233 (0) 302 611 611</a>
            </li>
            <li className="flex items-center gap-2">
              <Mail className="h-4 w-4 text-yellow" />
              <a href="mailto:info@ecgtc.edu.gh" className="text-white/70 hover:text-yellow transition-colors">info@ecgtc.edu.gh</a>
            </li>
          </ul>
      ...
      <div className="border-t border-white/5 bg-brand-dark/40">
        <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-3 px-6 py-5 text-[11px] text-white/40 tracking-wide">
          <span>© {new Date().getFullYear()} Electricity Company of Ghana Ltd. · ECG Training Centre. All Rights Reserved.</span>
          <div className="flex gap-4">
            <Link to="/help" className="hover:text-white transition-colors">Privacy Charter</Link>
            <span>·</span>
            <Link to="/help" className="hover:text-white transition-colors">Terms of Use</Link>
          </div>
        </div>
      </div>
    </footer>
